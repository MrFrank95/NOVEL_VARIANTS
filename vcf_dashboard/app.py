...
def load_data():
    ...
    vcf_path = os.path.join(os.path.dirname(__file__), "data", "joint_germline_recalibrated_VEP.ann.vcf")
...
page = st.sidebar.radio("Navigation pane", list(pages.keys()), label_visibility="collapsed")
